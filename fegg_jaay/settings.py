...
ALLOWED_HOSTS += ["healthcheck.railway.app", ".up.railway.app", ".onrender.com", "127.0.0.1", "localhost"]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "dashboard.context_processors.multi_boutique",
            ],
        },
    },
]
...
# ─── Email (notifications commerçants) ───────────────────────────────────────
...
DEFAULT_FROM_EMAIL = config("DEFAULT_FROM_EMAIL", default="noreply@feggjaay.shop")
